...
- [#37](https://github.com/cdryampi/gym/issues/37) Discovery del modulo Reservas.
- [#38](https://github.com/cdryampi/gym/issues/38) Discovery del modulo Miembros operativo.
