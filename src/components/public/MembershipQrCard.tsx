        ...
        <div className="mt-10 space-y-4">
          <div className="flex items-start gap-3 bg-black/[0.03] p-4 text-[11px] leading-relaxed text-[#5f6368]">
            ...
            <p className="uppercase tracking-tight font-medium">
              Usa este código en la terminal de acceso. La validación es instantánea y segura.
            </p>
          </div>
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            ...
            {detailHref && (
              <Button asChild variant="outline" className="h-12 border-black/10 text-[#111111] hover:bg-black hover:text-white">
